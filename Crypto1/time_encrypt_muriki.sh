...
mkdir -p encrypted_books_muriki
mkdir -p time_encrypted_books_muriki
...
do
    ...
    ./encrypt.py 31122025 < "$FILE"> "encrypted_books_muriki/$NAME"
    ...
    echo "A execucao levou $DIFF segundos" > "time_encrypted_books_muriki/$NAME"
done
